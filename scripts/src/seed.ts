...
async function main() {
  ...
  const eventData: EventSeedRow[] = [
    ...
    { title: "Resume Workshop for CS Majors", desc: "Get personalized resume feedback from recruiters at top tech companies. Limited spots!", start: futureDate(0, 16), duration: 1.5, bldg: 4, room: "A201", cat: catMap["Career & Professional"], club: clubMap["BYU CS Society"], cap: 30, food: false, tags: ["career", "resume", "tech"], cover: "/images/resume-workshop-cs-majors.png" },
    ...
    { title: "Ballroom Dance Social", desc: "No experience needed! Learn basic waltz and tango steps in a fun, welcoming environment.", start: futureDate(0, 19), duration: 2, bldg: 9, room: "Main Floor", cat: catMap["Arts & Culture"], club: clubMap["BYU Ballroom Dance Club"], cap: 100, food: false, tags: ["dance", "social", "beginner"], cover: "/images/ballroom-dancing.png" },
    ...
    { title: "BYU Trails: Rock Canyon Hike", desc: "Moderate 5-mile hike up Rock Canyon with stunning views of Utah Valley. Bring water and snacks.", start: futureDate(1, 8), duration: 4, bldg: 9, room: "Parking Lot A", cat: catMap["Sports & Fitness"], club: clubMap["BYU Hiking & Outdoors"], cap: 40, food: false, tags: ["hiking", "outdoors", "Rock Canyon"], cover: "/images/y-mountain-hiking.png" },
    ...
    // Day 5
    { title: "Modern Waltz Masterclass", desc: "Intensive 2-hour session on waltz technique taught by a former competitive champion.", start: futureDate(5, 15), duration: 2, bldg: 9, room: "Studio B", cat: catMap["Arts & Culture"], club: clubMap["BYU Ballroom Dance Club"], cap: 40, food: false, tags: ["waltz", "masterclass", "dance"], cover: "/images/ballroom-dancing.png" },
    ...
    { title: "Timpanogos Cave Day Trip", desc: "Guided tour of the spectacular Timpanogos Cave National Monument. Transportation provided!", start: futureDate(7, 7), duration: 8, bldg: 9, room: "Bus Pickup", cat: catMap["Sports & Fitness"], club: clubMap["BYU Hiking & Outdoors"], cap: 25, food: true, tags: ["cave", "hiking", "day trip"], cover: "/images/y-mountain-hiking.png" },
    // Day 8
    ...
    { title: "Tango Beginners Workshop", desc: "Learn the passionate Argentine tango from a certified instructor. No partner needed to sign up!", start: futureDate(9, 19), duration: 2, bldg: 9, room: "Studio A", cat: catMap["Arts & Culture"], club: clubMap["BYU Ballroom Dance Club"], cap: 50, food: false, tags: ["tango", "beginner", "dance"], cover: "/images/ballroom-dancing.png" },
    // Day 10
    ...
    // Day 13
    { title: "Mountain Bike Skills Clinic", desc: "Learn essential mountain biking techniques on trails around Provo. Bikes available for rent.", start: futureDate(13, 9), duration: 4, bldg: 9, room: "Parking Lot B", cat: catMap["Sports & Fitness"], club: clubMap["BYU Hiking & Outdoors"], cap: 20, food: false, tags: ["biking", "mountain bike", "outdoor"], cover: "/images/y-mountain-hiking.png" },
